...
$ ./bof2pico.py /path/to/sc_query.x64.o sc_query.x64.pico 'z:wirt' 'z:WSearch'
$ ./bof2pico.py /path/to/ask_mfa.x64.o ask_mfa.x64.pico 'i:31337'
```

When passing arguments, prefix each argument with a format specifier so that we understand how to convert it into a datatype that's compatible with the BOF argument format:
